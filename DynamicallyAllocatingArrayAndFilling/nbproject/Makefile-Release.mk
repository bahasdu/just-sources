...
${OBJECTDIR}/CheckPointer.o: CheckPointer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CheckPointer.o CheckPointer.cpp
...
${OBJECTDIR}/SearchMain.o: SearchMain.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SearchMain.o SearchMain.c

${OBJECTDIR}/ReferencePointerSample.o: ReferencePointerSample.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ReferencePointerSample.o ReferencePointerSample.cpp

...
${OBJECTDIR}/returnByReference.o: returnByReference.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/returnByReference.o returnByReference.cpp

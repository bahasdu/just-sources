...
${OBJECTDIR}/_ext/1372472398/Client.o: ../../Downloads/handout\ files/Client.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1372472398/Client.o ../../Downloads/handout\ files/Client.cpp

${OBJECTDIR}/_ext/1372472398/TestClasses.o: ../../Downloads/handout\ files/TestClasses.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1372472398
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1372472398/TestClasses.o ../../Downloads/handout\ files/TestClasses.cpp

${OBJECTDIR}/_ext/1372472398/Date.o: ../../Downloads/handout\ files/Date.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1372472398
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1372472398/Date.o ../../Downloads/handout\ files/Date.cpp

${OBJECTDIR}/_ext/1372472398/Advertisement.o: ../../Downloads/handout\ files/Advertisement.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1372472398
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1372472398/Advertisement.o ../../Downloads/handout\ files/Advertisement.cpp
